...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/front/css/morris.css') }}"/>
...
<section class="Repobank-wrapper">
    <div class="container-fluid">
        <div class="row title-row">
            ...
            <img class="color-logo" src="{{asset('assets/front/images/color_logo.png') }}" alt="">
        </div>
        ...
        <div class="launch-video">
            <p class="Launch-p"> Launch Video</p> <span class="pulse">
                <a href="#" data-toggle="modal" data-target="#video-modal">
                    <img src="{{asset('assets/front/images/video.png') }}" alt="video is not find ">
                </a>
            </span>
        </div>
                                            ...
                                            <div class="input_comparison">
                                                <div class="row">
                                                    <div class="input_comparison_select">
                                                        ...
                                                        <button type="button" class="tooltip_select"
                                                                data-toggle="tooltip" data-placement="top" title="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                        ...
                                        <div class="modal-header">
                                            ...
                                            <div class="modal_stage_prev">
                                                <button data-toggle="modal" data-target="#new_crypto_overdraft_1"
                                                        type="button" class="btn btn-primary" data-dismiss="modal"
                                                        aria-label="Close"><i class="fas fa-chevron-left"></i>
                                                </button>
                                                ...
                                                <div class="col-xl-6 col-lg-12 bank_transfer">
                                                    <div class="block_bg block_bg_right">
                                                        <div class="right_block">
                                                            <h3>Bank Transfer</h3>
                                                            <p class="text_blue">to any personal or business bank
                                                                account</p>
                                                        </div>
                                                    </div>
...
<section class="graphic">
    <div class="container-fluid">
        <div class="row">
            <div class="block-fluent col-lg-6 col-md-6">
                <div class="soft-enifite">
                    <h2 class="hard-cap"> Soft Cap $2 million</h2>
                    <p class="jewrc"> Use the funds & Token distribution</p>
                </div>
                <div class="blockwe">

                    <ul class="cass cass-grid">
                        <li> 35% IT DEVELOPMENT</li>
                        <li> 20% Marketing & Sale</li>
                        <li> 15% Admin & Operations</li>
                        <li> 10% Legal</li>
                        <li> 20% Reserve & Unespected Cost</li>
                    </ul>
            ...
            <div class="block-fluent-2 col-lg-6 col-md-6">
                <div class="soft-enifite">
                    <h2 class="hard-cap"> Hard Cap $46 million</h2>
                    <p class="jewrc"> Use the funds & Token distribution</p>
                </div>
                <div class="blockwe-2">
                    <div id="graph-number2" style="  width: 600px; height: 400px;"></div>

                    <ul class="cass cass-left">
                        <li> 18% IT DEVELOPMENT</li>
                        <li> 20% Marketing & Sale</li>
                        <li> 10% Admin & Operations</li>
                        <li> 7% Legal</li>
                        <li> 15% Reserve & Unespected Cost</li>
                        <li> 30% Licensing insurer</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row margin-row-about-us">
            ...
            <div class="description-out-img col-md-6">
                <p>The RepoBank team introduce innovative and adaptable solutions for the financial world. It is an
                    opportunity to make the system as efficient as possible.
                    The problem of the lack of financing in the digital economy is solved with the help of the
        ...
        <div class="solutions">
                    ...
                    <div id="collapseOne-first" class="collapse" aria-labelledby="headingOne" data-parent=".accordion">
                        <div class="card-body">
                            ...
                            <div class="bottom-part">
                                <p class="text">This process from the beginning to the end takes at least a few days,
                                    and can last up to several months. Depends on asset class.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo-first" class="collapse" aria-labelledby="headingTwo" data-parent=".accordion">
                        <div class="card-body">
                            ...
                            <div class="bottom-part">
                                <p class="text">Lack of convenient use of digital finance for profitable investments
                                    without the need to sell investments with excellent growth potential.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseThree-first" class="collapse" aria-labelledby="headingThree"
                        ...
                        <div class="card-body">
                            ...
                            <div class="bottom-part">
                                <p class="text">During transactions, we have to pay a transaction fee. That is why, a
                                    digital asset is an object for taxes. Short-term liquidation is inefficient.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseFour-first" class="collapse" aria-labelledby="headingThree"
                        ...
                        <div class="card-body">
                            ...
                            <div class="bottom-part">
                                <p class="text">To gain access to unsecured financing, long and complex credit checks
                                    need to be conducted. In the course of this, the credit score may get very low.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseFive-first" class="collapse" aria-labelledby="headingThree"
                        ...
                        <div class="card-body">
                            ...
                            <div class="bottom-part">
                                <p class="text">Transactions take place only with P2P agreements. For both sides there
                                    is no security and transparency.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="accordion" id="accordion-two">
                ...
                <div class="card">
                    ...
                    <div id="collapseOne-second" class="collapse" aria-labelledby="headingOne"
                        ...
                        <div class="card-body" data-parent=".accordion">
                            ...
                            <div class="bottom-part">
                                <p class="text">Make quick access to cash in any convenient place. Possible options:
                                    bank transfer, cryptocurrency, credit card from NepoBank. There is satisfaction of
                                    the client's needs and desire for liquidity.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo-second" class="collapse" aria-labelledby="headingTwo"
                         data-parent="#accordion-two">
                        <div class="card-body">
                            <div class="top-part">
                                <img src="{{asset('assets/front/images/yes.png') }}" class="glo-image" alt="">
                            ...
                            <div class="bottom-part">
                                <p class="text">Your digital asset will be 100% yours. Now you do not need to sell
                                    assets. Get the maximum profit from saving.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseThree-second" class="collapse" aria-labelledby="headingThree"
                         data-parent="#accordion-two">
                        <div class="card-body">
                            <div class="top-part">
                                <img src="{{asset('assets/front/images/yes.png') }}" class="glo-image" alt="">
                            ...
                            <div class="bottom-part">
                                <p class="text">Crypto overdrafts is exactly the effective and adaptable solution that
                                    does not be as the objects of taxes. Without any hidden fees.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseFour-second" class="collapse" aria-labelledby="headingThree"
                         data-parent="#accordion-two">
                        <div class="card-body">
                            <div class="top-part">
                                <img src="{{asset('assets/front/images/yes.png') }}" class="glo-image" alt="">
                            ...
                            <div class="bottom-part">
                                <p class="text">Crypto Overdraft does not need these checks, as this often leads to a
                                    significant downgrade of the credit score.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseFive-second" class="collapse" aria-labelledby="headingThree"
                         data-parent="#accordion-two">
                        <div class="card-body">
                            <div class="top-part">
                                <img src="{{asset('assets/front/images/yes.png') }}" class="glo-image" alt="">
                            ...
                            <div class="bottom-part">
                                <p class="text">All the assets is provided with transparent Blockchain overdraft
                                    contracts.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseSix-second" class="collapse" aria-labelledby="headingThree"
                         data-parent="#accordion-two">
                        <div class="card-body">
                            <div class="top-part">
                                <img src="{{asset('assets/front/images/yes.png') }}" class="glo-image" alt="">
        ...
        <div class="our_vision_slider_panel">
            ...
            <div>
                ...
                <p class="text_signature">
                    Analysts say that the result of the introduction of blockchain technology will be an increase in the
                    value of digital currency. In 2025, the value of deposits will reach $5 trillion.
                </p>
            </div>
            ...
            <div>
                ...
                <p class="text_signature">
                    It is also will continue to get tokenized hard assets. It includes Real estate, Commodities, all
                    types of Securities and Virtual Assets, Gaming and Virtual Reality Assets, Loyalty Reward Points.
                </p>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="wrapper-download-block">
                                    ...
                                    <div class=" btn-div">
                                        <a class="shirne-a load btn-download" href="#"> <i class="fas fa-download"></i>
                                            Download </a> </span>
                                    </div>
                                </div>
                            </div>
...
<section id="real-road" class="roadmap">
    <div class="container-fluid">
        ...
        <p class="roadmap_view_p">
            Prior events that the company embodies to <br>improve the operation of the system and the lead in the crypto
            currency market.
        </p>
...
<!--[if IE]>
<script type="text/javascript" src="3rdparty/excanvas.js"></script><![endif]-->
<script src="{{asset('assets/front/js/jquery.knob.min.js') }}"></script>
<script src="{{asset('assets/front/js/jquery.ba-throttle-debounce.min.js') }}"></script>
<script src="{{asset('assets/front/js/jquery.redcountdown.js') }}"></script>
<script src="http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.2/raphael-min.js"></script>
<script src="{{asset('assets/front/js/morris.js') }}"></script>
