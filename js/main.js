...
$(document).ready(function() {
    ...
    $('.wrapper-team-slider').slick({
        ...
        dots: true,
        focusOnSelect: false,
        prevArrow: "<img class='slick-prev' src='images/team-left.png'>",
        nextArrow: "<img class='slick-next' src='images/team-right.png'>",
        slidesToShow: 3,
        responsive: [
            {
                breakpoint: 992,
    ...
    $('.our_vision_slider_panel').slick({
        ...
        dots: true,
        arrows: true,
        prevArrow: "<img class='slick-prev' src='images/arrow_left.png'>",
        nextArrow: "<img class='slick-next' src='images/arrow_right.png'>",
        focusOnSelect: true,
        slidesToShow: 3,
        responsive: [
            {
